...
pub(super) fn schema() -> Value {
    ...
    json!({
        ...
        "project_storage": {
            ...
            "optimized_copy": "prism --project <source.prism> optimized-copy --output <fresh.prism> rewrites one linear history with verified font subsets and exact per-revision snapshots; it rejects branches, active Undo cursors, unsupported fonts, non-reducing results, and every existing destination"
        },
        "agent_collaboration": {
