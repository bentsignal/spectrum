...
#[path = "renderer_paint.rs"]
mod paint;
#[cfg(test)]
use paint::{aligned_text_texture_bounds, quad_mesh};
use paint::{aligned_text_uv, layer_texture_bounds, paint_quad, paint_texture_shadow_preview};
