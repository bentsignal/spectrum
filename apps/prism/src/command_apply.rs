...
pub(super) fn apply_command(document: &mut Document, command: Command) -> Result<CommandOutput> {
    match command {
        ...
        Command::AddText {
            ...
            y,
            shaping,
        } => text::add(document, text, name, font_size, color, x, y, shaping),
        ...
        Command::UpdateText {
            ...
            font_size,
            color,
        } => text::update(document, id, text, font_size, color),
        Command::SetTextTypography { id, typography } => {
            text::set_typography(document, id, typography)
        }
